		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mouri_App",
									"targetURL": "#comMouriAppmouri-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comMouriAppmouri-display": {
								"semanticObject": "comMouriAppmouri",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.MouriApp.mouri",
									"url": sap.ui.require.toUrl("com/MouriApp/mouri")
								}
							}
						}
					}
